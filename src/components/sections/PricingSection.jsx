            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                >
                    ...
                    <p className="text-lg text-slate-600">
                        Investasi terbaik untuk meningkatkan produktivitas. Mulai dari yang gratis hingga skala enterprise.
                    </p>
                </div>
                    ...
                    {pricingPlans.map((plan, index) => (
                        <div
                            ...
                            className={`relative rounded-2xl p-8 flex flex-col h-full border transition-all duration-300 hover:-translate-y-2
                                ${plan.isPopular
                                    ? "bg-white border-blue-200 shadow-xl ring-2 ring-blue-600 shadow-blue-900/10"
                            ...
                            <ul className="space-y-4 mb-8 flex-1">
                                {plan.features.map((feature, index) => (
                                    <li key={index} className="flex items-start">
                                        <svg className="h-5 w-5 text-blue-600 shrink-0 mr-3" viewBox="0 0 20 20" fill="currentColor">
