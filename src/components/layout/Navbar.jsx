    ...
    return (
        <nav className="bg-white/90 backdrop-blur-sm border-b border-slate-200 sticky top-0 z-50">
            <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
                ...
                {/* LOGO */}
                <div className="flex items-center gap-2 font-bold text-2xl text-blue-900 cursor-pointer" onClick={() => window.scrollTo(0, 0)}>
                ...
                <div className="hidden md:flex gap-8 text-sm font-medium text-slate-600 items-center">
                    <a href="#masalah" className="hover:text-blue-600 transition-colors">Masalah Umum</a>
                    <a href="#solusi" className="hover:text-blue-600 transition-colors">Fitur</a>
                    <a href="#harga" className="hover:text-blue-600 transition-colors">Harga</a>

                    {/* CTA Button */}
                    <button
                        onClick={onOpenModal}
                        className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg text-sm font-bold transition-all shadow-lg shadow-blue-600/20 active:scale-95"
                    >
                        Jadwalkan Demo
                    </button>
                </div>
            ...
            {isMenuOpen && (
                <div className="md:hidden absolute top-20 left-0 w-full bg-white border-b border-slate-200 shadow-2xl flex flex-col p-6 space-y-4 animate-in slide-in-from-top-5 duration-200">
                    <a href="#masalah" onClick={handleLinkClick} className="text-lg font-medium text-slate-600 hover:text-blue-600">Masalah Umum</a>
                    <a href="#solusi" onClick={handleLinkClick} className="text-lg font-medium text-slate-600 hover:text-blue-600">Fitur & Solusi</a>
                    <a href="#harga" onClick={handleLinkClick} className="text-lg font-medium text-slate-600 hover:text-blue-600">Paket Harga</a>
                    ...
                    <button
                        ...
                        className="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-lg text-center font-bold shadow-md"
                    >
                        Hubungi Sales
                    </button>
                </div>
